...
validate_search_task = Task(
    ...
    Consignes :
    1. Vérifie que le format correspond exactement
    2. Vérifie qu'il y a au moins une URL valide
    3. Retourne un rapport comme :
    {
        "valid": true/false,
    ...
    expected_output="JSON de validation",
)

# Configuration du Crew avec verbose activé
crew = Crew(
